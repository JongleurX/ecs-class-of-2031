...
# Character dictionaries - students can expand and modify these!
HIRAGANA = {
    'あ': ['a'], 'い': ['i'], 'う': ['u'], 'え': ['e'], 'お': ['o'],
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            play_game(HIRAGANA, "Hiragana")
        elif choice == '2':
            play_game(KATAKANA, "Katakana")
        elif choice == '3':
            play_game(KANJI, "Kanji")
        elif choice == '4':
            print("Sayonara! さようなら!")
            break
        else:
