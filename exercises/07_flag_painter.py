...
def main():
    ...
    # Try different color combinations and function calls
    # The goal is to understand how the SAME geometry functions
    # can create different visual results by changing parameters
